...
namespace VeryAnimation
{
    public partial class VeryAnimation
    {
        ...
        public void UpdateSyncEditorCurveClip()
        {
            ...
            if (editorCurveWasModifiedDic != null && editorCurveWasModifiedDic.Count > 0)
            {
                ...
                foreach (var pair in editorCurveWasModifiedDic)
                {
                    ...
                    if (vaw.editorSettings.settingPropertyStyle != EditorSettings.PropertyStyle.Default)
                    {
        ...
        #region PoseTemplate
        [Flags]
        public enum PoseTemplateFlags : uint
        {
            Humanoid = (1 << 0),
            Generic = (1 << 1),
            BlendShape = (1 << 2),
        ...
        public void SavePoseTemplate(PoseTemplate poseTemplate, PoseTemplateFlags flags = PoseTemplateFlags.All)
        {
            poseTemplate.Reset();
            poseTemplate.isHuman = isHuman;
            #region Humanoid
            if (isHuman && (flags & PoseTemplateFlags.Humanoid) != 0)
            {
            ...
            #endregion
            #region BlendShape
            if ((flags & PoseTemplateFlags.BlendShape) != 0)
            {
        ...
        public void SaveSelectionPoseTemplate(PoseTemplate poseTemplate, PoseTemplateFlags flags = PoseTemplateFlags.All)
        {
        ...
        public void LoadPoseTemplate(PoseTemplate poseTemplate, bool updateAll = false, bool calcIK = false, PoseTemplateFlags flags = PoseTemplateFlags.All)
        {
            if (updateAll)
            {
            ...
            #region Humanoid
            if ((flags & PoseTemplateFlags.Humanoid) != 0)
            {
        ...
        public void SelectionCommonMirror()
        {
            #region Motion
        ...
        public void SelectionCommonResetAll()
        {
            #region Motion
            if (selectionMotionTool)
            {
